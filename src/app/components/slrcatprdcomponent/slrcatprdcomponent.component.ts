...
@Component({
  selector: 'app-slrcatprdcomponent',
  templateUrl: './slrcatprdcomponent.component.html',
  styleUrls: ['./slrcatprdcomponent.component.css']
})
export class SlrcatprdcomponentComponent {
